...
const { getDoctors, getDoctor, doctorById, deleteDoctor, updateDoctor, addprofilePicture, addLocation, getReviews, deleteReview, getPhoto, doctorData} = require('../../controllers/doctor/doctor')
